...
namespace AddressList
{
    public partial class Form3 : Form
    {
                 	    ...
                 	    while (sr.Peek()>1)
                  	    {
                            ...
                            richTextBox2.AppendText(strres + "\r\n");
                  	    }
            	    }
         	    }
    	    }
        ...
        private void SavePicture(string userId)
        {
            ...
            sw.Write(richTextBox2.Text);							//把richTextBox1中的内容写入文件
            /*关闭此文件*/
            sw.Flush();
            sw.Close();
        }
    	    ...
    	    if (insertdate)         						//如果插入新数据
    	    {
    	    ...
    	    else                						//更新数据
   	        {
        	    ...
        	    myDataSet.Tables["PersonList"].Rows[ipersonid-1][2] = dateTimePicker1.Text;	//出生时间
         	    ...
         	    myDataSet.Tables["PersonList"].Rows[ipersonid-1][6] = comboBox3.Text;	//性别
                ...
                myDataSet.Tables["PersonList"].Rows[ipersonid - 1][8] = richTextBox1.Text.Trim();	//备注
         	    myDataSet.Tables["PersonList"].Rows[ipersonid-1][9] = comboBox1.Text.Trim();//所在分组
    	    }
